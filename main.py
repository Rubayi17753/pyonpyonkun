...
from src.queries.launch_commutative import main as launch_commutative
...
def main():
	...
	prompt_dict = {
				...
				'q1': {'desc' : 'decompose an IDS (query)', 
		   				'action' : lambda: query_decomp()}, 
				'q2': {'desc' : "return a character's dependents (query)", 
		   				'action' : lambda: query_dep(fp=dirs.ids_elements_fp_json())},		   
				'q3': {'desc' : 'commutate an IDS', 
		   				'action' : lambda: launch_commutative()},
				}
